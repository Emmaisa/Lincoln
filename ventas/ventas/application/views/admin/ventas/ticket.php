...
$connector = new NetworkPrintConnector("192.168.2.62", 9100);
...
$printer -> text("Fecha: ".$venta->fecha." Hora: ".$venta->hora." \n");
...
$printer -> text("".str_pad($detalle->cantidad, 4, " ", STR_PAD_RIGHT)."  ".str_pad(cortar($detalle->nombre), 21, " ", STR_PAD_RIGHT)." ".str_pad((number_format($detalle->precio,3)), 5, " ", STR_PAD_RIGHT)." ".str_pad((number_format($detalle->importe,2)), 6, " ", STR_PAD_LEFT)."".$detalle->tipo."\n");

endforeach;
foreach($detalles1 as $detalle1):

$printer -> text("".str_pad($detalle1->cantidad, 4, " ", STR_PAD_RIGHT)."  ".str_pad(cortar($detalle1->nombre), 21, " ", STR_PAD_RIGHT)." ".str_pad((number_format($detalle1->precio,3)), 5, " ", STR_PAD_RIGHT)." ".str_pad((number_format($detalle1->importe,2)), 6, " ", STR_PAD_LEFT)."".$detalle1->tipo."\n");
