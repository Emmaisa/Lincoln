...
shortcut.add("f2",function() {
     var option = document.getElementById("producto3").focus();
});
...
?>" name="hora" id="hora">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" id="producto3" placeholder="Buscar el producto por nombre o escanee el codigo"  name="scanner" autofocus>
                               </div>
