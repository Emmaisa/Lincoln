...
shortcut.add("f2",function() {
     var option = document.getElementById("producto").focus();
});
                        ...
                        <form action="<?php echo base_url();?>movimientos/ventas/store" method="POST" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control comentario" id="comentario" name="comentario" >
                                </div>
...
?> 
" name="fecha"  required> <input type="hidden" class="form-control" value ="<?php setlocale(LC_ALL,"es_ES");
$hora= date ("h:i:s a");
echo ("$hora");
...
?>" name="hora" id="hora">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" id="producto" placeholder="Buscar el producto por nombre o escanee el codigo"  name="scanner" autofocus>
                               </div>
